          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            >
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <cite className="text-gray-200 not-italic">Pumla Mashwana</cite>{" "}
                -{" "}
              </div>
            </div>
            ...
            >
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <cite className="text-gray-200 not-italic">Hester Rossouw</cite>{" "}
                -{" "}
            ...
            >
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <cite className="text-gray-200 not-italic">Phillip Grutter</cite>{" "}
                -{" "}
