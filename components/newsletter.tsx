        ...
        >
          ...
          <div className="relative flex flex-col lg:flex-row justify-between items-center">
            ...
            <form className="w-full lg:w-1/2" onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-md lg:max-w-none mt-6">
                <input
                  type="tel"
                  value={mobileNumber}
              ...
              <div className="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-md lg:max-w-none mt-6">
                <div className="relative inline-flex w-full appearance-none bg-purple-700 border border-purple-500 focus:border-purple-300 rounded-sm px-4 py-3 mb-2 sm:mb-0 sm:mr-2 text-purple-400 placeholder-purple-400">
                  {`Your number of loaves: `}
                  <span className="text-white ml-1 font-bold italic">
                    {numberOfLoaves}
                  </span>
